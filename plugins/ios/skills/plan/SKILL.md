...
The iOS rules (`rules/ios.md` from this plugin) should be loaded via the project's CLAUDE.md. If `@.claude/ios-rules.md` is not imported in CLAUDE.md, suggest the user run `/ios:init` first, then stop.
