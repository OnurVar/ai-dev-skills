...
`rules/ios.md` should be imported via the project's CLAUDE.md (run `/ios:init` if not). Any reviewer that reads CLAUDE.md picks up the iOS scope and `## Review behavior` filter rules automatically.
