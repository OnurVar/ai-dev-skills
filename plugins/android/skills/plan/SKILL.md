...
The Android rules (`rules/android.md` from this plugin) should be loaded via the project's CLAUDE.md. If `@.claude/android-rules.md` is not imported in CLAUDE.md, suggest the user run `/android:init` first, then stop.
