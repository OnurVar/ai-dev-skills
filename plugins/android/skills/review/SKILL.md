...
`rules/android.md` should be imported via the project's CLAUDE.md (run `/android:init` if not). Any reviewer that reads CLAUDE.md picks up the Android scope and `## Review behavior` filter rules automatically.
